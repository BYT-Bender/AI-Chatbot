...
class SearchElement:
    def __init__(self, config):
        ...
        self.question_strings = ["what is", "tell me", "do you know", "are you aware of"]

    def load_element_data(self):
        element_data_path = os.path.join(self.config["parent_directory"], self.config["element_data"])
    ...
    def load_property_intents(self):
        property_intents_path = os.path.join(self.config["parent_directory"], self.config["element_intents"])
