...
class SearchConversation:
    ...
    def match_pattern(self, user_message):
        try:
            for intent in self.admin_commands.conversation_intents:
    ...
    def generate_response(self, user_message):
        ...
        if intent and "responses" in intent:
            ...
            self.utility.update_usage(self.config["data"]["conversation"]["usage"], response_id, "updating response usage data")
